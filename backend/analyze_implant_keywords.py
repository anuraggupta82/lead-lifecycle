...
implant_kws = [k for k in data if k["campaign"] == "nXtsmile Implants (05/23 — 100/day) (05/23 23:33)"]

ad_groups = {}
for kw in implant_kws:
    ag = kw["ad_group"]
...
print("\nTop 5 highest first-page estimate keywords in nXtsmile Implants:")
implant_kws.sort(key=lambda x: x["first_page_est"] or 0, reverse=True)
for k in implant_kws[:10]:
